...
`,
                            buttons = [
                                      ...
                                      await GojoMdNx.sendButtonText(m.chat, buttons, YTMASS, `𝐋𝐎𝐋𝐈 𝐁𝐎𝐓 𝐌𝐃` ,m)
                                  }
                                  break
...
`,
                            buttons = [
                              ...
                              case 'secytmp4': case 'secytvideo': {
                                  ...
                                  let quality = args[1] ? args[1] : '360p'
                                  let media = await ytv(text, quality)
                                  await GojoMdNx.sendText(m.chat, ` *ʟᴏᴀᴅɪɴɢ ${m.pushName} ʏᴏᴜʀ ᴠɪᴅᴇᴏ... 🔄*`)
                                  if (media.filesize >= 100000) return reply('❗ Video size is too big '+util.format(media)+'.mp4')
                                  GojoMdNx.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `🌟 𝗧𝗜𝗧𝗟𝗘 : ${media.title}\n👜 𝗙𝗜𝗟𝗘 𝗦𝗜𝗭𝗘 : ${media.filesizeF}\n🌼 𝗨𝗥𝗟 : ${isUrl(text)}\n🌍 𝗘𝗫𝗧 : MP3\n🔮 𝗥𝗘𝗦𝗢𝗟𝗨𝗧𝗜𝗢𝗡 : ${args[1] || '360p'}` }, { quoted: m })
                              ...
                              */
                              case '720ytmp4': case '720ytvideo': {
                                  ...
                                  if (meadia.filesize >= 150000) return GojoMdNx.sendButtonText(m.chat, buttons,`❗ ʏᴏᴜʀ ${media.title}.mp4 ᴠɪᴅᴇᴏ sɪᴢᴇ ᴛᴏ ʙɪɢ \n ᴛʀʏ 360ᴘ ᴏʀ ᴜsᴇ ᴛʜɪs ʟɪɴᴋ ᴅᴏᴡɴʟᴏᴀᴅ\n\nᴠɪᴅᴇᴏ sɪᴢᴇ :${media.filesizeF}`,m.pushName, m)
                                  GojoMdNx.sendMessage(m.chat, { video: { url: media.url }, mimetype: 'video/mp4', fileName: `DARK MAKER YTV.mp4`, caption: `© ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ ʟᴏʟɪ ʙᴏᴛ ᴍᴏᴅ` }, { quoted: m })
                              }
                              break
                          case 'getmusic': {
                                  let { yta } = require('./lib/y2mate')
                          ...
                          case 'shadow': case 'romantic': case 'smoke': case 'burnpapper': case 'naruto': case 'lovemsg': case 'grassmsg': case 'lovetext': case 'coffecup': case 'butterfly': case 'harrypotter': case 'retrolol': {
                              ...
                              var load = await GojoMdNx.sendText(m.chat, ` ʟᴏᴀᴅɪɴɢ ʏᴏᴜʀ ${m.pushName} ᴛɪᴋᴛᴏᴋ ᴠɪᴅᴇᴏ... 🔄`)
           ...
           case 'fb': case 'facebook': {
                ...
                await GojoMdNx.sendText(m.chat, ` ʟᴏᴀᴅɪɴɢ ʏᴏᴜʀ ${m.pushName} ғᴀᴄᴇ ʙᴏᴏᴋ ᴠɪᴅᴇᴏ ... 🔄`)
