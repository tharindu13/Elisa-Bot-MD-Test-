                                          ...
                                          hydratedTemplate: {
                                              ...
                                              hydratedButtons: [{
                                                  ...
                                                  quickReplyButton: {
                                                      ...
                                                      displayText: '🎬 VIDEO 🎬',
                                                      id: `typemessagevid ${search.all[0].url} `
                                                  }
                                              }]
                                          }
                                      }
...
`,
                            buttons = [
                                          { buttonId: `2ytmp4 ${text}`, buttonText: { displayText: '360p' }, type: 1 },
                                          { buttonId: `720ytmp4 ${text}`, buttonText: { displayText: '720p' }, type: 1 }
                                      ]
                                      await GojoMdNx.sendButtonText(m.chat, buttons, YTMASS, `ʟᴏʟɪ ᴍᴅ` ,m)
                                  }
                              ...
                              */
                              case '720ytmp4': case '720ytvideo': {
                                  ...
                                  if (media.filesize >= 150000) return reply(`❗ ᴠɪᴅᴇᴏ sɪᴢᴇ ᴛᴏ ʙɪɢ \n ᴛʀʏ 360ᴘ ᴏʀ ᴜsᴇ ᴛʜɪs ʟɪɴᴋ ᴅᴏᴡɴʟᴏᴀᴅ \n ʟɪɴᴋ - ${meadia.dl_link}`)
