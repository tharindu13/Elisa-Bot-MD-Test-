...
`,
                            buttons = [
                              ...
                              buttons = [
                                  ...
                                  ElisaBotMd.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: true, id: up.key.id, participant: m.quoted.sender } })
                              }
                              break
                          ...
                          case 'shadow': case 'romantic': case 'smoke': case 'burnpapper': case 'naruto': case 'lovemsg': case 'grassmsg': case 'lovetext': case 'coffecup': case 'butterfly': case 'harrypotter': case 'retrolol': {
                              ...
                              hydratedFooterText: `ᴇʟɪsᴀ ʙᴏᴛ ᴍᴅ ᴘᴜʙʟɪᴄ`,
                              hydratedButtons: [{
                              ...
                              anu = await fetchJson(`https://ravindumanoj-sew-api.herokuapp.com/main/download/tiktok?url=${text}&apikey=RavinduManoj`)
                              buf2 = await getBuffer(anu.result.audio)
           ...
           case 'fb': case 'facebook': {
                ...
                await ElisaBotMd.sendText(m.chat, ` ʟᴏᴀᴅɪɴɢ ʏᴏᴜʀ ${m.pushName} ғᴀᴄᴇ ʙᴏᴏᴋ ᴠɪᴅᴇᴏ ... 🔄`)
