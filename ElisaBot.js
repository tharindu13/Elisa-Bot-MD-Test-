...
🌀 ᴜʀʟ : ${search.all[0].ago}
 ...
 `,
			...
			break*/
                ...
                buffer = fs.readFileSync('./Elisa.jpg')
let buttons = [
...
case 'antilink': {
             ...
             break
                          ...
                          let { webp2mp4File } = require('./lib/uploader')
                                  ...
                                  await ElisaBotMd.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: global.cap } }, { quoted: m })
...
`,
    ...
    headerType: 2
                                  ...
                                  if (media.filesize >= 100000) return reply('❗ Video size is too big '+util.format(media)+'.mp4')
                                  var up = await ElisaBotMd.sendButtonText(m.chat, buttonMessage, AGAINTRY, `${m.pushName} Use this only if you have not received the request.` ,m)
                              ...
                              */
                              case '720ytmp4': case '720ytvideo': {
                                  ...
                                  ElisaBotMd.sendMessage(m.chat, { video: { url: media.url }, mimetype: 'video/mp4', fileName: `DARK MAKER YTV.mp4`, caption: global.cap }, { quoted: m })
                              }
                              break
                          case 'getmusic': {
                                  let { yta } = require('./lib/y2mate')
...
maker.textpro("https://textpro.me/create-glitch-text-effect-style-tik-tok-983.html", [
    `${teks1}`,`${teks2}`])
  .then((data) => ElisaBotMd.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
...
case 'lava': case 'rock': case 'bloodglas': case 'halloween': case 'darkgold': case 'joker': case 'wicker':
 case 'firework': case 'skeleton': case 'blackpink': case 'sand': case 'glue': case '1917': case 'leaves': case 'demon': {
             ...
             let anu = await maker.textpro(link, q)
                ...
                ElisaBotMd.sendMessage(m.chat, { image: { url: anu }, caption: global.cap }, { quoted: m })
             }
             break
...
👋hello..${m.pushName} 😼${global.alive}            
 `
                  message = await prepareWAMessageMedia({ image : { url: ' https://github.com/DarkCreater2004/Tutug/raw/zim-bot-inc/Elisa.jpg' } }, { upload:   ElisaBotMd.waUploadToServer })
                                  template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                                      templateMessage: {
                                          hydratedTemplate: {
                                              imageMessage: message.imageMessage,
                  ...
                  const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                                      templateMessage: {
                                          hydratedTemplate: {
                                              ...
                                              locationMessage: {
                                              jpegThumbnail: fs.readFileSync('./image/Elisa.jpg')},
                                              hydratedFooterText: `𝐐𝐮𝐞𝐞𝐧 𝐄𝐥𝐢𝐬𝐚 𝐁𝐞𝐭𝐚 𝐄𝐝𝐢𝐭𝐢𝐨𝐧`,
                                              hydratedButtons: [{
                                                  urlButton: {
                                                      displayText: 'SUBSCRIBE',
